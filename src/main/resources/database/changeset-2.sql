INSERT INTO public.users(user_name, password) VALUES ('user', '1234');
INSERT INTO public.addresses(district, street, number_of_house, apartment_number) VALUES ('ЗАО', 'Рябиновая', 1, 2);
INSERT INTO public.users_info(name, email, phone_number, user_id, address_id) VALUES ('user', 'user@mail.ru', '12345678', 1, 1);
INSERT INTO public.categories(title) VALUES ('УШМ');
INSERT INTO public.categories(title) VALUES ('Перфораторы');
INSERT INTO public.categories(title) VALUES ('Аккумуляторный инструмент');
INSERT INTO public.products(category_id, user_info_id, title, link_to_the_image, specification, price, is_busy) VALUES (1, 1, 'УШМ',
...
INSERT INTO public.products(category_id, user_info_id, title, link_to_the_image, specification, price, is_busy) VALUES (1, 1, 'УШМ',
 'https://kanion-sochi.ru/upload/iblock/583/yfs5ejr8zf9rcqw0f3ryvjfvfh5rcja0/76718417_20d4_11de_822d_001bb9bd9c74_962e2258_3546_11e7_93f3_e61f13e05487.jpeg',
  ' Небольшой пример текста, который должен основываться на названии карточки и составлять основную часть содержимого карты', 234, 'false');
INSERT INTO public.products(category_id, user_info_id, title, link_to_the_image, specification, price, is_busy) VALUES (2, 1, 'Перфоратор',
...
INSERT INTO public.products(category_id, user_info_id, title, link_to_the_image, specification, price, is_busy) VALUES (2, 1, 'Перфоратор',
 'https://dokamir.com.ua/image/data/985_1.jpg',
  ' Небольшой пример текста, который должен основываться на названии карточки и составлять основную часть содержимого карты', 234, 'false');
INSERT INTO public.products(category_id, user_info_id, title, link_to_the_image, specification, price, is_busy) VALUES (3, 1, 'Шуруповерт',
